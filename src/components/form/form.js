...
import { initialLoginCredentials, initialRegisterCredentials } from '../.././utils/objects';
...
const Form = (props) => {
    ...
    const initialState = loginPage ? initialLoginCredentials : initialRegisterCredentials

    const { register, handleSubmit, reset, setFocus, watch, } = useForm({ defaultValues: initialState });
